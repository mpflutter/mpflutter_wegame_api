...
class AddCardOption {
  ...
  List<AddCardRequestInfo> get cardList {
    return ($$context$$['cardList'] as mpjs.JSArray)
        .value()
...
class AdvertiseReqObj {
  ...
  List<ManufacturerData>? get manufacturerData {
    return ($$context$$['manufacturerData'] as mpjs.JSArray)
        .value()
...
class BLEPeripheralService {
  ...
  List<Characteristic> get characteristics {
    return ($$context$$['characteristics'] as mpjs.JSArray)
        .value()
...
class BannerAd {
  ...
  void offResize([OffResizeCallback? listener]) {
    final result = $$context$$
        .callMethod('offResize', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void onError(GridAdOnErrorCallback listener) {
    final result = $$context$$.callMethod('onError', [
      ListenerManager.addListener(
        listener,
        (res) => GridAdOnErrorListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onResize(OnResizeCallback listener) {
    final result = $$context$$.callMethod('onResize', [
      ListenerManager.addListener(
        listener,
        (res) => OnResizeListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
...
class Characteristic {
  ...
  List<Descriptor>? get descriptors {
    return ($$context$$['descriptors'] as mpjs.JSArray)
        .value()
...
class ChooseImageSuccessCallbackResult {
  ...
  List<ImageFile> get tempFiles {
    return ($$context$$['tempFiles'] as mpjs.JSArray)
        .value()
...
class CustomAd {
  ...
  void offHide([OffHideCallback? listener]) {
    final result = $$context$$
        .callMethod('offHide', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void onError(CustomAdOnErrorCallback listener) {
    final result = $$context$$.callMethod('onError', [
      ListenerManager.addListener(
        listener,
        (res) => CustomAdOnErrorListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onHide(OnHideCallback listener) {
    final result = $$context$$.callMethod('onHide', [
      ListenerManager.addListener(
        listener,
        (res) => GeneralCallbackResult($$context$$: res),
      )
...
class FaceDetectSuccessCallbackResult {
  ...
  List<IAnyObject> get faceInfo {
    return ($$context$$['faceInfo'] as mpjs.JSArray)
        .value()
  ...
  List<IAnyObject> get pointArray {
    return ($$context$$['pointArray'] as mpjs.JSArray)
        .value()
        .map((it) => IAnyObject($$context$$: it))
        .toList();
  }
...
class FeedbackButton {
  ...
  void offTap([GameClubButtonOffTapCallback? listener]) {
    final result = $$context$$
        .callMethod('offTap', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void onTap(GameClubButtonOnTapCallback listener) {
    final result = $$context$$.callMethod('onTap', [
      ListenerManager.addListener(
        listener,
        (res) => GeneralCallbackResult($$context$$: res),
      )
...
class GetBLEDeviceServicesSuccessCallbackResult {
  ...
  List<BLEService> get services {
    return ($$context$$['services'] as mpjs.JSArray)
        .value()
...
class GetBeaconsSuccessCallbackResult {
  ...
  List<BeaconInfo> get beacons {
    return ($$context$$['beacons'] as mpjs.JSArray)
        .value()
...
class GetFriendCloudStorageSuccessCallbackResult {
  ...
  List<UserGameData> get data {
    return ($$context$$['data'] as mpjs.JSArray)
        .value()
...
class GetFriendsStateDataSuccessCallbackResult {
  ...
  List<StateData> get list {
    return ($$context$$['list'] as mpjs.JSArray)
        .value()
...
class GetGameClubDataOption {
  ...
  List<DataType> get dataTypeList {
    return ($$context$$['dataTypeList'] as mpjs.JSArray)
        .value()
...
class GetSavedFileListSuccessCallbackResult {
  ...
  List<FileItem> get fileList {
    return ($$context$$['fileList'] as mpjs.JSArray)
        .value()
...
class GetUserCloudStorageSuccessCallbackResult {
  ...
  List<KVData> get KVDataList {
    return ($$context$$['KVDataList'] as mpjs.JSArray)
        .value()
...
class MatchGroupInfo {
  ...
  List<MatchMemberInfo> get memberInfoList {
    return ($$context$$['memberInfoList'] as mpjs.JSArray)
        .value()
...
class OnMatchListenerResult {
  ...
  List<MatchGroupInfo> get groupInfoList {
    return ($$context$$['groupInfoList'] as mpjs.JSArray)
        .value()
...
class OnRoomInfoChangeListenerResult {
  ...
  List<RoomMemberInfo> get memberList {
    return ($$context$$['memberList'] as mpjs.JSArray)
        .value()
...
class OnTouchStartListenerResult {
  ...
  List<Touch> get changedTouches {
    return ($$context$$['changedTouches'] as mpjs.JSArray)
        .value()
  ...
  List<Touch> get touches {
    return ($$context$$['touches'] as mpjs.JSArray)
        .value()
        .map((it) => Touch($$context$$: it))
        .toList();
  }
...
class PreviewMediaOption {
  ...
  List<MediaSource> get sources {
    return ($$context$$['sources'] as mpjs.JSArray)
        .value()
...
class RequestException {
  ...
  List<ExceptionReason> get reasons {
    return ($$context$$['reasons'] as mpjs.JSArray)
        .value()
...
class UserInfoButton {
  ...
  void onTap(UserInfoButtonOnTapCallback listener) {
    final result = $$context$$.callMethod('onTap', [
      ListenerManager.addListener(
        listener,
        (res) => OnTapListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
...
class VKBodyAnchor {
  ...
  List<VKOrigin> get points {
    return ($$context$$['points'] as mpjs.JSArray)
        .value()
...
class Video {
  ...
  void offProgress([OffProgressCallback? listener]) {
    final result = $$context$$
        .callMethod('offProgress', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void onError(VideoOnErrorCallback listener) {
    final result = $$context$$.callMethod('onError', [
      ListenerManager.addListener(
        listener,
        (res) => VideoOnErrorListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onProgress(OnProgressCallback listener) {
    final result = $$context$$.callMethod('onProgress', [
      ListenerManager.addListener(
        listener,
        (res) => OnProgressListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onTimeUpdate(VideoOnTimeUpdateCallback listener) {
    final result = $$context$$.callMethod('onTimeUpdate', [
      ListenerManager.addListener(
        listener,
        (res) => OnTimeUpdateListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
...
class DownloadTask {
  ...
  void onHeadersReceived(DownloadTaskOnHeadersReceivedCallback listener) {
    final result = $$context$$.callMethod('onHeadersReceived', [
      ListenerManager.addListener(
        listener,
        (res) => DownloadTaskOnHeadersReceivedListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
...
class GameServerManager {
  ...
  void offBeKickedOut([OffBeKickedOutCallback? listener]) {
    final result = $$context$$.callMethod(
        'offBeKickedOut', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offBroadcast([OffBroadcastCallback? listener]) {
    final result = $$context$$
        .callMethod('offBroadcast', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offDisconnect([OffDisconnectCallback? listener]) {
    final result = $$context$$.callMethod(
        'offDisconnect', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offGameEnd([OffGameEndCallback? listener]) {
    final result = $$context$$
        .callMethod('offGameEnd', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offGameStart([OffGameStartCallback? listener]) {
    final result = $$context$$
        .callMethod('offGameStart', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offInvite([OffInviteCallback? listener]) {
    final result = $$context$$
        .callMethod('offInvite', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offLockStepError([OffLockStepErrorCallback? listener]) {
    final result = $$context$$.callMethod(
        'offLockStepError', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offLogout([OffLogoutCallback? listener]) {
    final result = $$context$$
        .callMethod('offLogout', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offMatch([OffMatchCallback? listener]) {
    final result = $$context$$
        .callMethod('offMatch', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offRoomInfoChange([OffRoomInfoChangeCallback? listener]) {
    final result = $$context$$.callMethod(
        'offRoomInfoChange', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offStateUpdate([OffStateUpdateCallback? listener]) {
    final result = $$context$$.callMethod(
        'offStateUpdate', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offSyncFrame([OffSyncFrameCallback? listener]) {
    final result = $$context$$
        .callMethod('offSyncFrame', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void onBeKickedOut(OnBeKickedOutCallback listener) {
    final result = $$context$$.callMethod('onBeKickedOut', [
      ListenerManager.addListener(
        listener,
        (res) => OnBeKickedOutListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onBroadcast(OnBroadcastCallback listener) {
    final result = $$context$$.callMethod('onBroadcast', [
      ListenerManager.addListener(
        listener,
        (res) => OnBroadcastListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onDisconnect(OnDisconnectCallback listener) {
    final result = $$context$$.callMethod('onDisconnect', [
      ListenerManager.addListener(
        listener,
        (res) => GameServerManagerOnDisconnectListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onGameEnd(OnGameEndCallback listener) {
    final result = $$context$$.callMethod('onGameEnd', [
      ListenerManager.addListener(
        listener,
        (res) => OnGameEndListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onGameStart(OnGameStartCallback listener) {
    final result = $$context$$.callMethod('onGameStart', [
      ListenerManager.addListener(
        listener,
        (res) => GeneralCallbackResult($$context$$: res),
      )
  ...
  void onInvite(OnInviteCallback listener) {
    final result = $$context$$.callMethod('onInvite', [
      ListenerManager.addListener(
        listener,
        (res) => OnInviteListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onLockStepError(OnLockStepErrorCallback listener) {
    final result = $$context$$.callMethod('onLockStepError', [
      ListenerManager.addListener(
        listener,
        (res) => OnLockStepErrorListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onLogout(OnLogoutCallback listener) {
    final result = $$context$$.callMethod('onLogout', [
      ListenerManager.addListener(
        listener,
        (res) => GeneralCallbackResult($$context$$: res),
      )
  ...
  void onMatch(OnMatchCallback listener) {
    final result = $$context$$.callMethod('onMatch', [
      ListenerManager.addListener(
        listener,
        (res) => GameServerManagerOnMatchListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onRoomInfoChange(OnRoomInfoChangeCallback listener) {
    final result = $$context$$.callMethod('onRoomInfoChange', [
      ListenerManager.addListener(
        listener,
        (res) =>
            GameServerManagerOnRoomInfoChangeListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onStateUpdate(OnStateUpdateCallback listener) {
    final result = $$context$$.callMethod('onStateUpdate', [
      ListenerManager.addListener(
        listener,
        (res) => GameServerManagerOnStateUpdateListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onSyncFrame(OnSyncFrameCallback listener) {
    final result = $$context$$.callMethod('onSyncFrame', [
      ListenerManager.addListener(
        listener,
        (res) => OnSyncFrameListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
...
class RequestTask {
  ...
  void onHeadersReceived(RequestTaskOnHeadersReceivedCallback listener) {
    final result = $$context$$.callMethod('onHeadersReceived', [
      ListenerManager.addListener(
        listener,
        (res) => RequestTaskOnHeadersReceivedListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
...
class Wx {
  ...
  void offDeviceOrientationChange(
    ...
    final result = $$context$$.callMethod('offDeviceOrientationChange',
        [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void offGyroscopeChange([OffGyroscopeChangeCallback? listener]) {
    final result = $$context$$.callMethod(
        'offGyroscopeChange', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void offKeyDown([OffKeyDownCallback? listener]) {
    final result = $$context$$
        .callMethod('offKeyDown', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offKeyUp([OffKeyUpCallback? listener]) {
    final result = $$context$$
        .callMethod('offKeyUp', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offKeyboardComplete([OffKeyboardCompleteCallback? listener]) {
    final result = $$context$$.callMethod(
        'offKeyboardComplete', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offKeyboardConfirm([OffKeyboardConfirmCallback? listener]) {
    final result = $$context$$.callMethod(
        'offKeyboardConfirm', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void offKeyboardInput([OffKeyboardInputCallback? listener]) {
    final result = $$context$$.callMethod(
        'offKeyboardInput', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void offMouseDown([OffMouseDownCallback? listener]) {
    final result = $$context$$
        .callMethod('offMouseDown', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offMouseMove([OffMouseMoveCallback? listener]) {
    final result = $$context$$
        .callMethod('offMouseMove', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offMouseUp([OffMouseUpCallback? listener]) {
    final result = $$context$$
        .callMethod('offMouseUp', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void offShareAppMessage([OffShareAppMessageCallback? listener]) {
    final result = $$context$$.callMethod(
        'offShareAppMessage', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offShareTimeline([OffShareTimelineCallback? listener]) {
    final result = $$context$$.callMethod(
        'offShareTimeline', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offShow([OffShowCallback? listener]) {
    final result = $$context$$
        .callMethod('offShow', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offTouchCancel([OffTouchCancelCallback? listener]) {
    final result = $$context$$.callMethod(
        'offTouchCancel', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void offTouchMove([OffTouchMoveCallback? listener]) {
    final result = $$context$$
        .callMethod('offTouchMove', [ListenerManager.removeListener(listener)]);
    return result;
  }

  void offTouchStart([OffTouchStartCallback? listener]) {
    final result = $$context$$.callMethod(
        'offTouchStart', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void offWheel([OffWheelCallback? listener]) {
    final result = $$context$$
        .callMethod('offWheel', [ListenerManager.removeListener(listener)]);
    return result;
  }
  ...
  void onAddToFavorites(OnAddToFavoritesCallback listener) {
    final result = $$context$$.callMethod('onAddToFavorites', [
      ListenerManager.addListener(
        listener,
        (res) => OnAddToFavoritesListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onBLEPeripheralConnectionStateChanged(
    ...
    final result =
      ...
      ListenerManager.addListener(
        listener,
        (res) => OnBLEPeripheralConnectionStateChangedListenerResult(
            $$context$$: res),
      )
    ]);
    return result;
  ...
  void onBeaconServiceChange(OnBeaconServiceChangeCallback listener) {
    final result = $$context$$.callMethod('onBeaconServiceChange', [
      ListenerManager.addListener(
        listener,
        (res) => OnBeaconServiceChangeListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onDeviceOrientationChange(OnDeviceOrientationChangeCallback listener) {
    final result = $$context$$.callMethod('onDeviceOrientationChange', [
      ListenerManager.addListener(
        listener,
        (res) => OnDeviceOrientationChangeListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onGyroscopeChange(OnGyroscopeChangeCallback listener) {
    final result = $$context$$.callMethod('onGyroscopeChange', [
      ListenerManager.addListener(
        listener,
        (res) => OnGyroscopeChangeListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onHandoff(OnHandoffCallback listener) {
    final result = $$context$$.callMethod('onHandoff', [
      ListenerManager.addListener(
        listener,
        (res) => OnHandoffListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onKeyDown(OnKeyDownCallback listener) {
    final result = $$context$$.callMethod('onKeyDown', [
      ListenerManager.addListener(
        listener,
        (res) => OnKeyDownListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onKeyUp(OnKeyUpCallback listener) {
    final result = $$context$$.callMethod('onKeyUp', [
      ListenerManager.addListener(
        listener,
        (res) => OnKeyDownListenerResult($$context$$: res),
      )
  ...
  void onKeyboardComplete(OnKeyboardCompleteCallback listener) {
    final result = $$context$$.callMethod('onKeyboardComplete', [
      ListenerManager.addListener(
        listener,
        (res) => GeneralCallbackResult($$context$$: res),
      )
  ...
  void onKeyboardConfirm(OnKeyboardConfirmCallback listener) {
    final result = $$context$$.callMethod('onKeyboardConfirm', [
      ListenerManager.addListener(
        listener,
        (res) => OnKeyboardInputListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onKeyboardInput(OnKeyboardInputCallback listener) {
    final result = $$context$$.callMethod('onKeyboardInput', [
      ListenerManager.addListener(
        listener,
        (res) => OnKeyboardInputListenerResult($$context$$: res),
      )
  ...
  void onMouseDown(OnMouseDownCallback listener) {
    final result = $$context$$.callMethod('onMouseDown', [
      ListenerManager.addListener(
        listener,
        (res) => OnMouseDownListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onMouseMove(OnMouseMoveCallback listener) {
    final result = $$context$$.callMethod('onMouseMove', [
      ListenerManager.addListener(
        listener,
        (res) => OnMouseMoveListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onMouseUp(OnMouseUpCallback listener) {
    final result = $$context$$.callMethod('onMouseUp', [
      ListenerManager.addListener(
        listener,
        (res) => OnMouseDownListenerResult($$context$$: res),
      )
  ...
  void onShareAppMessage(OnShareAppMessageCallback listener) {
    final result = $$context$$.callMethod('onShareAppMessage', [
      ListenerManager.addListener(
        listener,
        (res) => OnShareAppMessageListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onShareMessageToFriend(OnShareMessageToFriendCallback listener) {
    final result = $$context$$.callMethod('onShareMessageToFriend', [
      ListenerManager.addListener(
        listener,
        (res) => OnShareMessageToFriendListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onShareTimeline(OnShareTimelineCallback listener) {
    final result = $$context$$.callMethod('onShareTimeline', [
      ListenerManager.addListener(
        listener,
        (res) => OnShareTimelineListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onShow(OnShowCallback listener) {
    final result = $$context$$.callMethod('onShow', [
      ListenerManager.addListener(
        listener,
        (res) => OnShowListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onTouchCancel(OnTouchCancelCallback listener) {
    final result = $$context$$.callMethod('onTouchCancel', [
      ListenerManager.addListener(
        listener,
        (res) => OnTouchStartListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onTouchEnd(OnTouchEndCallback listener) {
    final result = $$context$$.callMethod('onTouchEnd', [
      ListenerManager.addListener(
        listener,
        (res) => OnTouchStartListenerResult($$context$$: res),
      )
  ...
  void onTouchMove(OnTouchMoveCallback listener) {
    final result = $$context$$.callMethod('onTouchMove', [
      ListenerManager.addListener(
        listener,
        (res) => OnTouchStartListenerResult($$context$$: res),
      )
  ...
  void onTouchStart(OnTouchStartCallback listener) {
    final result = $$context$$.callMethod('onTouchStart', [
      ListenerManager.addListener(
        listener,
        (res) => OnTouchStartListenerResult($$context$$: res),
      )
  ...
  void onWheel(OnWheelCallback listener) {
    final result = $$context$$.callMethod('onWheel', [
      ListenerManager.addListener(
        listener,
        (res) => OnWheelListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
  ...
  void onWindowResize(OnWindowResizeCallback listener) {
    final result = $$context$$.callMethod('onWindowResize', [
      ListenerManager.addListener(
        listener,
        (res) => OnWindowResizeListenerResult($$context$$: res),
      )
    ]);
    return result;
  }
